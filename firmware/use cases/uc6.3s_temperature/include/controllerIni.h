...
const char MQTT_CLIENT_ID[]         = "sub6_3";         //naming convention <sub/pub><use case>_<node#>
const char MQTT_BROKER_IP[]         = "192.168.0.101";
const char MQTT_BROKER_NAME[]       = "envisecmqtt1";
const int MQTT_BROKER_PORT          = 1883;
const char MQTT_TOPIC1[]            = "uc6_3_1";       //temperature
const char MQTT_TOPIC2[]            = "uc6_3_2";       //humidity
const double UPPER_THRESHOLD        = 26;              //Threholds for event based publisher
const double LOWER_THRESHOLD        = 400;              //Threholds for event based publisher
