...
const char MQTT_CLIENT_ID[]   = "pub2_1";         //namingconvention <sub/pub><use case>_<node#>
...
#define UPPER_THRESHOLD 400   //set upper event limit as an integer
#define LOWER_THRESHOLD 399   //set lower event limit as an integer
